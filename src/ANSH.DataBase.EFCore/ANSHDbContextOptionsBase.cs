...
namespace ANSH.DataBase.EFCore {
    ...
    public abstract class ANSHDbContextOptionsBase<TEntity> : ANSHDbContextBase where TEntity : class, IANSHDbEntityBase, new () {
        ...
        /// <param name="anshDbParameters">sql查询参数</param>
        /// <returns>返回受影响的行数</returns>
        public virtual int SQLNonQuery (string tSql, List<Connection.ANSHDbParameter> anshDbParameters = null) {
            return base.ANSHDbConnection.ExecuteSQLNonQuery (tSql, anshDbParameters);
        }
        ...
        public virtual object SQLScalar (string tSql, List<Connection.ANSHDbParameter> anshDbParameters = null) {
            return base.ANSHDbConnection.ExecuteSQLScalar (tSql, anshDbParameters);
        }
        ...
        /// <param name="outPutANSHDbparameter">输出参数</param>
        /// <param name="pageIndex">第几页</param>
        /// <param name="pageSize">每页多少条</param>
        /// <returns>Page语句</returns>
        public string CreatePageTSQL (string tSql, string orderBy, out ANSHDbParameter outPutANSHDbparameter, int pageIndex = 1, int pageSize = 20) {
...
FETCH NEXT {pageSize} ROWS ONLY ; {countSql}";
            outPutANSHDbparameter = new ANSHDbParameter () {
