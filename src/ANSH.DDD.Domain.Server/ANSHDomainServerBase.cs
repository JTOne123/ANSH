...
namespace ANSH.DDD.Domain.Server {
    ...
    public abstract class ANSHDomainServerBase<TIANSHRepository, Entity, TPKey> : IANSHDomainServer<TIANSHRepository, Entity, TPKey>
        ...
        where TPKey : struct, IEquatable<TPKey> {
            ...
            // /// <returns>返回满足条件的实体</returns>
            // public virtual Entity GetOne (TPKey Id) => IRepository.GetOne (Id);
            ...
            // /// <param name="Id">主键</param>
            // /// <returns>返回满足条件的实体</returns>
            // public virtual Task<Entity> GetOneAsync (TPKey Id) => IRepository.GetOneAsync (Id);
            ...
            // /// <returns>返回满足条件的实体数量</returns>
            // public Task<int> CountAsync (Expression<Func<Entity, bool>> criteria) => IRepository.CountAsync (criteria);
            ...
            // /// <param name="criteria">条件</param>
            // /// <returns>返回满足条件的实体</returns>
            // public List<Entity> GetList (Expression<Func<Entity, bool>> criteria) => IRepository.GetList (criteria);
            ...
            // /// <param name="criteria">条件</param>
            // /// <returns>返回满足条件的实体</returns>
            // public Task<Entity> GetOneAsync (Expression<Func<Entity, bool>> criteria) => IRepository.GetOneAsync (criteria);
            ...
            // /// <param name="criteria">条件</param>
            // /// <returns>返回满足条件的实体</returns>
            // public Entity GetOne (Expression<Func<Entity, bool>> criteria) => IRepository.GetOne (criteria);
            ...
            // /// <param name="criteria">条件</param>
            // /// <returns>返回满足条件的实体</returns>
            // public Task<List<Entity>> GetListAsync (Expression<Func<Entity, bool>> criteria) => IRepository.GetListAsync (criteria);
