...
namespace ANSH.DDD.Domain.Server {
    ...
    public interface IANSHDomainAggregateServer<TIANSHAggregateRootRepository, TAggregateRoot, TPKey> : IANSHDomainServer<TIANSHAggregateRootRepository, TAggregateRoot, TPKey>
